...
user_list = [Christian,Christian,Christian,Christian,Christian,Christian,Christian,Christian,Christian]
...
def signup():
    ...
    if(len(user_list) < 10):
        ...
        signupButton2 = tk.Button(signupWindow, text="Sign Up", font=("Comic Sans MS", 15))
